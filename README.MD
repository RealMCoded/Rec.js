...
*tl;dr: You cannot distribute closed source versions, and if you mofidy this software you **must** link back to the original project which can be found [here](https://github.com/RealMCoded/Rec.js).*
